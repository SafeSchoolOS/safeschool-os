...
export function BadgePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center text-white p-8">
      <div className="bg-white text-gray-900 rounded-3xl p-12 max-w-md w-full text-center shadow-2xl">
        ...
        <button onClick={() => window.print()}
          className="w-full p-3 bg-blue-600 text-white rounded-xl hover:bg-blue-500 transition-colors mb-3">
          Print Badge
        </button>
      </div>

      <button onClick={() => navigate('/')} className="mt-8 text-gray-400 hover:text-white text-lg">
        Done
      </button>
    </div>
  );
