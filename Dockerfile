...
COPY --from=build-api /app/packages/integrations/audio-analytics/dist ./packages/integrations/audio-analytics/dist
COPY --from=build-api /app/packages/integrations/audio-analytics/package.json ./packages/integrations/audio-analytics/package.json
