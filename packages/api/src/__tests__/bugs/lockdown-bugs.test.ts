...
describe('BUG: FLOOR scope does not filter by floor', () => {
   ...
   */
  it.skip('should only lock doors on the specified floor, not all building doors', async () => {
...
describe('BUG: Lockdown release unlocks manually-locked emergency exit doors', () => {
   ...
   */
  it.skip('should not change emergency exit door status during lockdown release', async () => {
    const token = await authenticateAs(app, 'admin');
...
describe('BUG: ZONE scope not implemented', () => {
   ...
   */
  it.skip('should only lock doors in the specified zone, not all site doors', async () => {
