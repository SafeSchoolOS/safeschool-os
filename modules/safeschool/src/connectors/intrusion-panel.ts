 ...
 *
 * Integrates with burglar/intrusion alarm panels (Bosch, DSC, Honeywell Vista,
 * DMP) for:
 ...
 *
 * Targets panels with IP/REST gateway adapters (e.g., Bosch B/G series,
 * Honeywell IP panels, or third-party adapters like Alarm.com or EyezOn).
 */
