 ...
 *
 * Most fire panels expose events via serial/BACnet/Modbus. This connector
 * targets panels with a REST/TCP gateway adapter (e.g., fire panel → IP gateway → this).
 */
...
export interface FireAlarmConfig extends ConnectorConfig {
  gatewayUrl: string;           // IP gateway URL
  apiKey?: string;
